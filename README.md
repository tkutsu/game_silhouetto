...
Each part of the shape gets its own seeded PBR material, picked from 29 CC0 texture sets from ambientCG and Poly Haven, one per family and chosen for strong surface bumps (bark, wicker, rope, roofing tiles, pizza, sponge, candy, snow and more; see `public/textures/CREDITS.md`). Materials never affect the score, which only sees the bare geometry.
